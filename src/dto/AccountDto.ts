...
export const ModificaPasswordDto = z
    .object({
        oldPassword: z.string().min(10, "La vecchia password deve contenere almeno 10 caratteri."),
        newPassword: z.string().min(10, "La nuova password deve contenere almeno 10 caratteri."),
    })
